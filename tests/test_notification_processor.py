...
def mock_user_repository():
    with patch("app.services.notification_processor.get_user_by_id") as mock_get, patch(
        "app.services.notification_processor.create_user"
    ) as mock_create:
...
def test_should_notify_tarea_email_enabled():
...
def test_should_notify_tarea_email_disabled():
...
def test_should_notify_tarea_push_enabled():
...
def test_should_notify_tarea_push_disabled():
...
def test_should_notify_examen_email_enabled():
...
def test_should_notify_examen_email_disabled():
...
def test_should_notify_examen_push_enabled():
...
def test_should_notify_examen_push_disabled():
...
def test_get_user_preferences_existing_user(mock_user_repository):
...
def test_get_user_preferences_create_new_user(mock_user_repository):
...
@pytest.mark.asyncio
async def test_process_user_notification_success(
...
@pytest.mark.asyncio
async def test_process_user_notification_user_info_error(
    mock_user_repository, mock_user_service
):
...
@pytest.mark.asyncio
async def test_process_course_notification_success(
    mock_courses_service,
    mock_user_service,
    mock_user_repository,
    mock_format_notification,
    mock_email_service,
...
@pytest.mark.asyncio
async def test_process_course_notification_no_users(mock_courses_service):
...
@pytest.mark.asyncio
async def test_process_course_notification_user_info_error_continues(
    mock_courses_service,
    mock_user_service,
    mock_user_repository,
    mock_format_notification,
...
@pytest.mark.asyncio
async def test_process_aux_teacher_notification_success(
    mock_user_repository,
    mock_user_service,
    mock_format_notification,
    mock_email_service,
    ...
    # Verificar que se obtuvo información del usuario
    mock_user_service.assert_called_once_with(1)
    # Verificar que se formateo la notificación
    mock_format_notification.assert_called_once()
...
@pytest.mark.asyncio
async def test_process_aux_teacher_notification_user_info_error(
    mock_user_repository, mock_user_service
):
...
@pytest.mark.asyncio
async def test_process_message_user_notification(
    mock_user_repository,
    mock_user_service,
    mock_format_notification,
    mock_email_service,
...
@pytest.mark.asyncio
async def test_process_message_course_notification(
    mock_courses_service,
    mock_user_service,
    mock_user_repository,
    mock_format_notification,
...
@pytest.mark.asyncio
async def test_process_message_aux_teacher_notification(
    mock_user_repository,
    mock_user_service,
    mock_format_notification,
    mock_email_service,
...
@pytest.mark.asyncio
async def test_process_message_invalid_event_type():
    """Test que verifica el manejo de tipo de evento inválido"""
    invalid_data = {"event_type": "invalid_type", "id_user": 1}
...
async def test_process_message_exception_handling():
    ...
    with patch(
        "app.services.notification_processor.process_user_notification"
    ) as mock_process:
...
@pytest.mark.asyncio
async def test_process_user_notification_create_user_if_not_exists(
    mock_user_repository,
    mock_user_service,
    mock_format_notification,
    mock_email_service,
